(() => {
  ...
  function StreamProcessorWorklet() {
  ...
  // lib/utils.js
  function functionToIIFEBlobSrc(fn) {
  ...
  var WavStreamPlayer = class {
    ...
    constructor({ sampleRate = 44100 } = {}) {
      this.scriptSrc = functionToIIFEBlobSrc(StreamProcessorWorklet);
      this.sampleRate = sampleRate;
      this.context = null;
      this.stream = null;
      this.analyser = null;
  ...
  function AudioProcessorWorklet() {
  ...
  var WavRecorder = class {
    ...
    constructor({
      ...
      this.scriptSrc = functionToIIFEBlobSrc(AudioProcessorWorklet);
      this.sampleRate = sampleRate;
